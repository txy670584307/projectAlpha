...
@router.post(
    "/tickets", response_model=TicketResponse, status_code=201, tags=["tickets"]
)
...
async def update_ticket(
    ticket_id: int, ticket_in: TicketUpdate, db: AsyncSession = Depends(get_db)
):
...
@router.patch(
    "/tickets/{ticket_id}/complete", response_model=TicketResponse, tags=["tickets"]
)
...
@router.patch(
    "/tickets/{ticket_id}/uncomplete", response_model=TicketResponse, tags=["tickets"]
)
