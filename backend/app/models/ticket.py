...
class Ticket(Base):
    ...
    status = Column(String(20), nullable=False, default="open", comment="状态：open-未完成, closed-已完成")
    ...
    tags = relationship("Tag", secondary="ticket_tags", back_populates="tickets", lazy="selectin")
